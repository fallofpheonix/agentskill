...
const CLIENT_ID_ENV = "OPENCODE_ANTIGRAVITY_CLIENT_ID";
const CLIENT_SECRET_ENV = "OPENCODE_ANTIGRAVITY_CLIENT_SECRET";
...
function getOAuthCredentials() {
  ...
  if (!clientId || !clientSecret) {
    throw new Error(`Missing OAuth credentials. Set ${CLIENT_ID_ENV} and ${CLIENT_SECRET_ENV}.`);
  }
