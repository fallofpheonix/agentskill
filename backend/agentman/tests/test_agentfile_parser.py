...
"""
        ...
        assert openai_secret.values["API_KEY"] == "test-openai-key"
        assert openai_secret.values["BASE_URL"] == "https://api.openai.com/v1"

        # Check anthropic secret values
        assert anthropic_secret.values["API_KEY"] == "test-anthropic-key"
...
"""
        ...
        assert secret.values["API_KEY"] == "test-openai-key"
